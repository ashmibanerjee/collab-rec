...
class GPTo4Mini(LLMBaseClass):
    """
    Initializes a GPT-4o-mini Instruct object
    """

    def __init__(self, location=None) -> None:
        self.model_id = "o4-mini",
        super().__init__(self.model_id)
...
class Claude3Point7Sonnet(LLMBaseClass):
    """
       Initializes a Claude object
    """

    def __init__(self, location="europe-west1") -> None:
        # self.model_id = "claude-3-5-sonnet@20240620",
        self.model_id = "claude-3-7-sonnet@20250219",
        super().__init__(self.model_id, location=location)


class MistralLarge(LLMBaseClass):
    """
       Initializes a Mistral Large object
    """

    def __init__(self, location="europe-west4") -> None:
        self.model_id = "mistral-large-2411",
        super().__init__(self.model_id, location=location)
...
class Gemini2Point5Flash(LLMBaseClass):
    """
       Initializes a Gemini Flash object
       """

    def __init__(self, location="global") -> None:
...
class DeepSeekChatV3(LLMBaseClass):
    """
    Initializes a DeepSeek Chat object.
    """
...
class DeepSeekReasoner(LLMBaseClass):
    """
    Initializes a DeepSeek Chat object.
    """
...
class Llama4Maverick17B(LLMBaseClass):
    """
       Initializes a Llama object
       """
    ...
    def __init__(self, location=None) -> None:
        ...
        super().__init__(self.model_id, location="us-east5")
